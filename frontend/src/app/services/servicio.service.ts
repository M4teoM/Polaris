...
export class ServicioService {
  ...
  private servicios: Servicio[] = [
    {
      ...
      descripcionDetallada: 'Disfrute de masajes terapéuticos, aromaterapia, baños termales y tratamientos faciales premium.',
      precio: 180000,
    ...
    },
    {
      ...
      descripcionDetallada: 'Nuestro chef ejecutivo crea menús de temporada con ingredientes locales y técnicas de vanguardia.',
      precio: 95000,
    ...
    },
    {
      ...
      descripcionDetallada: 'Salas de reuniones equipadas con tecnología de punta, videoconferencia HD y espacios de coworking.',
      precio: 50000,
    ...
    },
    {
      ...
      descripcionDetallada: 'Piscina infinita con vista panorámica, gimnasio con equipos de última generación y clases de yoga.',
      precio: 45000,
    ...
    },
    {
      ...
      descripcionDetallada: 'Nuestro equipo organiza reservas exclusivas, transporte de lujo, tours privados y solicitudes especiales.',
      precio: 0,
    ...
    },
    {
      ...
      descripcionDetallada: 'Menú gourmet disponible las 24 horas con presentación impecable desde desayunos hasta cenas románticas.',
      precio: 35000,
  ...
  private testimonios: Testimonio[] = [
    ...
    {
      id: 3,
      texto: 'La combinación perfecta de lujo moderno y elegancia atemporal. Cada aspecto superó mis expectativas.',
